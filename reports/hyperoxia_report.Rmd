...
cohort_pao2 <- read_csv("~/Desktop/Hyperoxia_2020/cohort_pao2.csv")
cohort_pao2_staged <- read_csv("~/Desktop/Hyperoxia_2020/cohort_pao2_staged.csv")
TableOverall <- read_csv("~/Desktop/Hyperoxia_2020/data/TableOverall.csv")
```
