-- create time_weighted_spo2 temporary view

drop materialized view if exists time_weighted_spo2; 
create materialized view time_weighted_spo2 as
-- create temporary view time_weighted_spo2 as
(
    ...
    select icustay_id, 
        ...
        end as time_weighted_24hr_spo2 
    from
    (
